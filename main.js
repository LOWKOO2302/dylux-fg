...
global.reloadHandler = async function (restatConn) {
  ...
  conn.sSubject = '*⚠️ANUNCIO PUBLICO⚠️ 𒂶 HOLA A TODOS 😎✌️ SEAN BIENVENIDOS AL GRUPO 📲 PORFAVOR DE RESPECTAR LAS REGLAS DEL GRUPO GRACIAS Y SIGAN DISFRUTANDO DEL GRUPO*🤗 \n@group'
